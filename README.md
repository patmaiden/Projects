...
**Find PI to the Nth Digit** [COMPLETE] - Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.
...
**Prime Factorization** [COMPLETE] - Have the user enter a number and find all Prime Factors (if there are any) and display them.
...
**Count Vowels** [COMPLETE] - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.
